...
export default function CustomizedSolutionPage(){
    return (
        <ServiceTemplatePage 
            ...
            title={"Create your Cusomized Solution"}    
            description={["Your business is unique, and your talent needs are too.", "We work closely with you to develop tailored solutions that address your specific challenges and objectives ", "We work closely with you to develop tailored solutions that address your specific challenges and objectives"]}
            image={image_url}
            whatWeDo={whatWeDo}
            faqs={faqs}
        />
