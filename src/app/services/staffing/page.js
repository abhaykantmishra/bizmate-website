...
export default function CustomizedSolutionPage(){
    return (
        <ServiceTemplatePage 
            serviceName={"Staffing Solutions & Services"}
            title={"Manage your Associate Team with ease"}    
            description={["Equipped with in depth knowledge of Labour legislation and its compliance and experienced backhand team we provide Staffing solutions to take care of entire lifecycle of associates team members, where client has its management & control while being away from day-to-day management, administrative processing, Payroll and legal hassles"]}
            image={image_url}
            whatWeDo={whatWeDo}
            faqs={faqs}
        />
