...
export default function CustomizedSolutionPage(){
    return (
        <ServiceTemplatePage 
            serviceName={"Recruitment Solution & Services"}
            title={"Get Recruitment Services to Grow Your Business"}    
            description={
            [
                "“Perfection is myth” and necessity of hiring a right fit is beyond the JobDescription",
                "Our focus is just not matching the JD with the perspective candidate, but a 360 analysis of individual for a most suitable fit for the company, role & position", 
                // "We work closely with you to develop tailored solutions that address your specific challenges and objectives"
            ]
            }
            image={image_url}
            whatWeDo={whatWeDo}
